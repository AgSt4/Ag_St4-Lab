...
include-before-body:
  text: |
    ...
    \newcommand{\myName}{Agustín Sandoval Tapia}
    \newcommand{\myInstitution}{Instituto de Economía - PUC}
    \newcommand{\mySignature}{\calligra AgustínST}
...
format:
  ...
  beamer:
    ...
    pdf-engine: xelatex
    aspectratio: 169
    classoption: "allowframebreaks, dvipsnames"
    keep-tex: true
---
