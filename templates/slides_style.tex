...
\usepackage{graphicx, tcolorbox, pgfplots, multicol, ragged2e, cancel, amsmath, tikz, booktabs, threeparttable, caption, array, dcolumn, pgfplotstable}
...
% --- 9. CIERRE AUTOMÁTICO (CORREGIDO) ---
\AtEndDocument{%
  \begin{frame}{¡Terminamos!}
    \begin{center}
        \myName \par \vspace{0.2cm}
        Cualquier consulta pueden escribir a: \par
        \correo{\myEmail} \par 
        \vspace{0.5cm}
        \hrule 
        \vspace{0.5cm}
