...
\titlegraphic{\hfill\includegraphics[height=1cm]{../../../../templates/UC_COLOR-01.png}}

% Redefinir información del documento usando metadatos de Quarto
\makeatletter
\AtBeginDocument{%
  \title{\huge \textbf{\@title}}
  \subtitle{\myCourse}
  \date{\@date}
  \author{\textbf{Nombre: }\myName \quad | \quad \textbf{Correo: }\correo{\myEmail}}
  \institute{\myInstitution}
}
\makeatother

% Agregar automáticamente tabla de contenidos después del título
\AtBeginDocument{%
